...
ActiveRecord::Schema.define(version: 2012_10_10_131232) do
  ...
  create_table "assignments", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "submission_cluster_groups", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.index ["assignment_id", "description"], name: "index_submission_cluster_groups_on_assignment_id_and_description"
    t.index ["assignment_id"], name: "index_submission_cluster_groups_on_assignment_id"
  end

  create_table "submission_cluster_memberships", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "submission_clusters", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "submission_logs", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "submission_id", null: false
  ...
  create_table "submission_similarities", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "assignment_id", null: false
  ...
  create_table "submission_similarity_mappings", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "submission_similarity_id", null: false
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["submission_similarity_id"], name: "index_submission_similarity_mappings_on_submission_similarity_id"
  end

  create_table "submission_similarity_processes", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "assignment_id", null: false
    t.integer "pid"
  ...
  create_table "user_course_memberships", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "name"
    t.string "full_name"
    t.string "password_digest", default: "$2a$12$2I6IVeDJWv83xG1aBLHGa.94i7HWSMLUPNWAn.g/aF00GRaXjWzGK"
